          ...
          - generic [ref=f1e6]:
            - generic:
              - link "Contact us" [ref=f1e10] [cursor=pointer]:
                - /url: https://lovely-friends.demo.prestashop.com/en/contact-us
              - generic [ref=f1e11]:
                - button "Language dropdown" [ref=f1e15]:
                  - text: English
                  - generic [ref=f1e16] [cursor=pointer]: 
                - link " Sign in" [ref=f1e19] [cursor=pointer]:
                  - /url: https://lovely-friends.demo.prestashop.com/en/login?back=https%3A%2F%2Flovely-friends.demo.prestashop.com%2Fen%2F%3Fid_module_showcased%3Dundefined
                  - generic [ref=f1e20]: 
                  - text: Sign in
                - generic [ref=f1e23]:
        ...
        - generic [ref=f1e27]:
          - heading "PrestaShop" [level=1] [ref=f1e29]:
            - link "PrestaShop" [ref=f1e30] [cursor=pointer]:
              - /url: https://lovely-friends.demo.prestashop.com/en/
              - img "PrestaShop" [ref=f1e31]
          - generic [ref=f1e32]:
            - list [ref=f1e34]:
              - listitem [ref=f1e35]:
                - link "Clothes" [ref=f1e36] [cursor=pointer]:
                  - /url: https://lovely-friends.demo.prestashop.com/en/3-clothes
              - listitem [ref=f1e37]:
                - link "Accessories" [ref=f1e38] [cursor=pointer]:
                  - /url: https://lovely-friends.demo.prestashop.com/en/6-accessories
              - listitem [ref=f1e39]:
                - link "Art" [ref=f1e40] [cursor=pointer]:
                  - /url: https://lovely-friends.demo.prestashop.com/en/9-art
            - generic [ref=f1e42]:
        ...
        - generic [ref=f1e51]:
              ...
              - option [ref=f1e54]:
                - link [ref=f1e55] [cursor=pointer]:
                  ...
                  - figure [ref=f1e56]:
                    - img [ref=f1e57]
                    - generic [ref=f1e58]:
                      - heading [level=2] [ref=f1e59]: Sample 3
                      - generic [ref=f1e60]:
          ...
          - generic [ref=f1e69]:
                ...
                - generic [ref=f1e74]:
                  - generic [ref=f1e75]:
                    - link "Hummingbird printed t-shirt" [ref=f1e76] [cursor=pointer]:
                      - /url: https://lovely-friends.demo.prestashop.com/en/men/1-1-hummingbird-printed-t-shirt.html#/1-size-s/8-color-white
                    ...
                    - generic [ref=f1e79]:
                      ...
                      - generic [ref=f1e82]:
                        ...
                        - link "Black" [ref=f1e84] [cursor=pointer]:
                          - /url: https://lovely-friends.demo.prestashop.com/en/men/1-2-hummingbird-printed-t-shirt.html#/1-size-s/11-color-black
                  - generic [ref=f1e85]:
                ...
                - generic [ref=f1e95]:
                  - generic [ref=f1e96]:
                    - link "Brown bear printed sweater" [ref=f1e97] [cursor=pointer]:
                      - /url: https://lovely-friends.demo.prestashop.com/en/women/2-9-brown-bear-printed-sweater.html#/1-size-s
                ...
                - generic [ref=f1e113]:
                  - generic [ref=f1e114]:
                    - link "The best is yet to come' Framed poster" [ref=f1e115] [cursor=pointer]:
                      - /url: https://lovely-friends.demo.prestashop.com/en/art/3-13-the-best-is-yet-to-come-framed-poster.html#/19-dimension-40x60cm
                ...
                - generic [ref=f1e129]:
                  - generic [ref=f1e130]:
                    - link "The adventure begins Framed poster" [ref=f1e131] [cursor=pointer]:
                      - /url: https://lovely-friends.demo.prestashop.com/en/art/4-16-the-adventure-begins-framed-poster.html#/19-dimension-40x60cm
                ...
                - generic [ref=f1e145]:
                  - generic [ref=f1e146]:
                    - link "Today is a good day Framed poster" [ref=f1e147] [cursor=pointer]:
                      - /url: https://lovely-friends.demo.prestashop.com/en/art/5-19-today-is-a-good-day-framed-poster.html#/19-dimension-40x60cm
                ...
                - generic [ref=f1e161]:
                  - generic [ref=f1e162]:
                    - link "Mug The best is yet to come" [ref=f1e163] [cursor=pointer]:
                      - /url: https://lovely-friends.demo.prestashop.com/en/home-accessories/6-mug-the-best-is-yet-to-come.html
                ...
                - generic [ref=f1e177]:
                  - generic [ref=f1e178]:
                    - link "Mug The adventure begins" [ref=f1e179] [cursor=pointer]:
                      - /url: https://lovely-friends.demo.prestashop.com/en/home-accessories/7-mug-the-adventure-begins.html
                ...
                - generic [ref=f1e193]:
                  - generic [ref=f1e194]:
                    - link "Mug Today is a good day" [ref=f1e195] [cursor=pointer]:
                      - /url: https://lovely-friends.demo.prestashop.com/en/home-accessories/8-mug-today-is-a-good-day.html
            ...
            - link "All products " [ref=f1e207] [cursor=pointer]:
              - /url: https://lovely-friends.demo.prestashop.com/en/2-home
              - text: All products
              - generic [ref=f1e208]: 
          ...
          - generic [ref=f1e215]:
            ...
            - link "All sale products " [ref=f1e257] [cursor=pointer]:
              - /url: https://lovely-friends.demo.prestashop.com/en/prices-drop
                ...
                - list [ref=f1e282]:
                  ...
                  - listitem [ref=f1e285]:
                    - link "New products" [ref=f1e286] [cursor=pointer]:
                      - /url: https://lovely-friends.demo.prestashop.com/en/new-products
                  - listitem [ref=f1e287]:
                    - link "Best sellers" [ref=f1e288] [cursor=pointer]:
                      - /url: https://lovely-friends.demo.prestashop.com/en/best-sellers
              - generic [ref=f1e289]:
                - paragraph [ref=f1e290]: Our company
                - list [ref=f1e291]:
                  - listitem [ref=f1e292]:
                    - link "Delivery" [ref=f1e293] [cursor=pointer]:
                      - /url: https://lovely-friends.demo.prestashop.com/en/content/1-delivery
                  - listitem [ref=f1e294]:
                    - link "Legal Notice" [ref=f1e295] [cursor=pointer]:
                      - /url: https://lovely-friends.demo.prestashop.com/en/content/2-legal-notice
                  - listitem [ref=f1e296]:
                    - link "Terms and conditions of use" [ref=f1e297] [cursor=pointer]:
                      - /url: https://lovely-friends.demo.prestashop.com/en/content/3-terms-and-conditions-of-use
                  - listitem [ref=f1e298]:
                    - link "About us" [ref=f1e299] [cursor=pointer]:
                      - /url: https://lovely-friends.demo.prestashop.com/en/content/4-about-us
                  - listitem [ref=f1e300]:
                    - link "Secure payment" [ref=f1e301] [cursor=pointer]:
                      - /url: https://lovely-friends.demo.prestashop.com/en/content/5-secure-payment
                  - listitem [ref=f1e302]:
                    - link "Contact us" [ref=f1e303] [cursor=pointer]:
                      - /url: https://lovely-friends.demo.prestashop.com/en/contact-us
                  - listitem [ref=f1e304]:
                    - link "Sitemap" [ref=f1e305] [cursor=pointer]:
                      - /url: https://lovely-friends.demo.prestashop.com/en/sitemap
                  - listitem [ref=f1e306]:
                    - link "Stores" [ref=f1e307] [cursor=pointer]:
                      - /url: https://lovely-friends.demo.prestashop.com/en/stores
            - generic [ref=f1e308]:
              - paragraph [ref=f1e309]:
                - link "Your account" [ref=f1e310] [cursor=pointer]:
                  - /url: https://lovely-friends.demo.prestashop.com/en/my-account
              - list [ref=f1e311]:
                - listitem [ref=f1e312]:
                  - link "Order tracking" [ref=f1e313] [cursor=pointer]:
                    - /url: https://lovely-friends.demo.prestashop.com/en/guest-tracking
                - listitem [ref=f1e314]:
                  - link "Sign in" [ref=f1e315] [cursor=pointer]:
                    - /url: https://lovely-friends.demo.prestashop.com/en/my-account
                - listitem [ref=f1e316]:
                  - link "Create account" [ref=f1e317] [cursor=pointer]:
                    - /url: https://lovely-friends.demo.prestashop.com/en/registration
                - listitem [ref=f1e318]:
                  - link "My alerts" [ref=f1e319] [cursor=pointer]:
                    - /url: //lovely-friends.demo.prestashop.com/en/module/ps_emailalerts/account
            - generic [ref=f1e320]:
